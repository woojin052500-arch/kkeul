...
import { AdFitNativeCard, AdFitBanner100, AdFitBanner100_Second } from './AdFit';
              ...
              >
                ...
                <div className="swipe-deck-container">
                  {(() => {
                    ...
                    const adIndices = [5, 11, 17, 23, 29, 35, 41]; // 4~6ê°?ê°„ê²©?¼ë¡œ ê´‘ê³  ?¸ì¶œ (ì²˜ìŒ 5ê°œëŠ” ë¬´ì¡°ê±??¼ë°˜ ì¹´ë“œ)
                    let insertedAds = 0;
                  ...
                  {studentMatchedAnnouncements
                    ...
                    studentMatchedAnnouncements
                      ...
                      .map((ann, idx) => {
                        ...
                        const showAd100_2 = idx === 15;
                        return (
                          <React.Fragment key={ann.id}>
                          {showAd100 && <AdFitBanner100 />}
                          {showAd100_2 && <AdFitBanner100_Second />}
                          <div
                    ...
                    >
                      ...
                      <div style={{
                        ...
                        <div style={{ background: '#FFF', padding: '10px', borderRadius: '16px', border: '1px solid #E2E8F0', boxShadow: '0 4px 12px rgba(0,0,0,0.05)' }}>
                          <QRCodeSVG value={`https://kkeul.vercel.app/p/${profile.id.split('-')[0]}`} size={110} level="M" />
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      if (Capacitor.isNativePlatform()) {
                        try {
                          await Share.share({
                            ...
                            url: 'https://kkeul.vercel.app' + '/p/' + profile.id.split('-')[0],
          ...
          <div className="animate-scale-in" onClick={(e) => e.stopPropagation()} style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                ?”’ {'https://kkeul.vercel.app'}/school-dashboard/manage
              </div>
              {/* Right spacer */}
